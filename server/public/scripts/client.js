  ...
  for (const task of getArray) {
    ...
    $("#noteList").append(`
      ...
      task.is_complete
                ...
                <button class="delete-button btn-sm btn btn-outline-danger m-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
